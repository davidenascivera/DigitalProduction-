...
// Generated:	Mon Jan 29 23:53:58 2024
...
static process*
nextofFunc2(load* thisObj)
{
	static int ind = 1;

	ind = (ind+1) % 2;
	return List2[ind].value(thisObj);
}
...
Label5: ; // Step 5
		...
		{
			thisObj->nextproc = nextofFunc2(thisObj); /* send to ... */
			EntityChanged(W_LOAD);
			retval = Continue;
			goto LabelRet;
		}
